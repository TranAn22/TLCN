...
public interface ProductRepository extends JpaRepository<Product,Long> {
    ...
    /*Customer*/
    @Query(value = "SELECT * FROM products p inner join categories c on p.category_id=c.category_id where c.is_deleted=false and p.is_deleted=false",nativeQuery = true)
